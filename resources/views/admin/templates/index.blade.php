    ...
    <div class="p-4 md:p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800">{{ $templates->count() ?? 0}}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600">{{ $templates->where('status', 'approved')->count() ?? 0 }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-yellow-600">{{ $templates->where('status', 'pending')->count() ?? 0 }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-red-600">{{ $templates->where('status', 'rejected')->count() ?? 0 }}</p>
                        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="px-4 md:px-6 py-3 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-gray-50/50">
                ...
                <div class="flex items-center gap-2">
                    <span class="text-sm text-gray-500">{{ $templates->count() ?? 0 }} templates found</span>
                </div>
            </div>
                                ...
                                <td class="px-4 md:px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        @php
                                            $deleteRoure = null;
                                            if(AdminLogin()){
                                                $deleteRoute=route('delete.template',$template->id);
                                            }else {
                                                $deleteRoute = route('template.delete',$template->id);
                                            }
                                        @endphp
